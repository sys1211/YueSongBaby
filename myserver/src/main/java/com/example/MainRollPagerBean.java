...
public class MainRollPagerBean implements Serializable{
    String StrPicUrl1;
    String StrPicUrl2;
    String StrPicUrl3;
    String StrPicUrl4;

    public MainRollPagerBean(String strPicUrl1, String strPicUrl2, String strPicUrl3, String strPicUrl4) {
